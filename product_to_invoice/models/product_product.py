...
class ProductProduct(models.Model):
    ...
    def action_add_to_invoice(self):
        ...
        move_lines = self.env['account.move.line'].sudo().search([
            ...
            ('move_id.state', '=', 'posted')], order="id desc")
        if move_lines and invoice_id.move_type == 'out_invoice':
            price_unit = move_lines[0].price_unit
        elif not move_lines and invoice_id.move_type == 'out_invoice':
